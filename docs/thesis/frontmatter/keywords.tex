...
\section*{מילות מפתח}
\endgroup
סביבות מבחן תצפיתיות לניתוח סיבתי; הערכת אומדים סיבתיים; בניית שכבת ייצוג; סדרות זמן לא־סדירות מטיפול נמרץ; מצבי־פרוקסי; הפקת ידע בסיוע \textenglish{LLM}; למידת מכונה סיבתית; למידת מכונה כפולה; יערות סיבתיים; רגישות למשתנים שהושמטו; \textenglish{MIMIC-III}; \textenglish{PhysioNet 2012}.
\end{hebrew}
