...
promoting proxy states to diagnoses or adjusted contrasts to proven effects. It
also distinguishes resource reuse from full historical reproducibility: the
former is demonstrated by explicit contracts and completed analyses, while the
latter still requires missing producing lineage and a verified rerun.
