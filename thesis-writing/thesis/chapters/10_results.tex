...
\caption{Archived predictive test performance for the five included model families.  AUROC, AUPRC, and minRP are macro-averaged across non-degenerate rule-derived proxy-label targets on the archived test split.}
