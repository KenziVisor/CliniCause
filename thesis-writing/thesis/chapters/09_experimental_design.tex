...
The crucial provenance gaps are processed-pickle hashes, split manifests, checkpoint-to-export mappings, exact producing wrappers/commands, archive-copy history, and the absence of final InterpNet artifacts.  A requirements file describes an intended software environment, not proof of the environment that produced an archived training summary or export.
