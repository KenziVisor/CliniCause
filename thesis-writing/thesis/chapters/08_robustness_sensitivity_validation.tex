...
\begin{longtable}{@{}L{0.16\linewidth}L{0.17\linewidth}L{0.21\linewidth}L{0.26\linewidth}L{0.13\linewidth}@{}}
...
\midrule
\endhead
Treated versus control counts, pairs, and match rate & \nolinkurl{matching/global_summary.csv}; per-treatment summaries & Whether the implemented matcher found comparison pairs & Propensity overlap, covariate balance, or positivity & archived; indirect only \\
Final Hamming distance and sufficient-pair flags & \nolinkurl{matching_causal_effect.py}; matching summaries & Similarity under the binary matching representation and support warnings & Similarity in the original covariate space or a target-population guarantee & implemented; archived \\
...
\sloppy
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{}L{0.13\linewidth}L{0.14\linewidth}L{0.14\linewidth}L{0.17\linewidth}L{0.17\linewidth}L{0.17\linewidth}@{}}
...
\sloppy
\setlength{\tabcolsep}{3pt}
\begin{longtable}{@{}L{0.15\linewidth}L{0.16\linewidth}L{0.20\linewidth}L{0.12\linewidth}L{0.17\linewidth}L{0.13\linewidth}@{}}
...
Run-summary stage status & None; archived orchestration record & Stage command, log, expected outputs & \nolinkurl{run_summary.json} & Execution and provenance audit & Status is not scientific validity \\
