...
\midrule
Design time & Dataset description and clinical sources $\rightarrow$ structured LLM elicitation $\rightarrow$ proposed ontology, rules, missingness considerations, and DAG $\rightarrow$ project selection and source-code encoding. & Prompts document proposals; active source defines implementation; formal clinical review remains incomplete. \\
