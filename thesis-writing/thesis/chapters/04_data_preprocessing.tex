...
\StagePlaceholder{[RESULT REQUIRED: final number of included PhysioNet records after preprocessing]}
...
\StagePlaceholder{[RESULT REQUIRED: final number of included MIMIC-III ICU stays after preprocessing]}
...
\StagePlaceholder{[FIGURE REQUIRED: audited dataflow diagram linking raw data, causal artifacts, STraTS artifacts, proxy labels, and causal analysis]}
...
\StagePlaceholder{[VALIDATION REQUIRED: checksums for processed PhysioNet and MIMIC-III dataset artifacts]}
\StagePlaceholder{[VALIDATION REQUIRED: provenance of train/validation/test split generation for final STraTS artifacts]}
